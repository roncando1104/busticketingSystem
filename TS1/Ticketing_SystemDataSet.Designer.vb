...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("Ticketing_SystemDataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class Ticketing_SystemDataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As Ticketing_SystemDataSet = CType(MyBase.Clone,Ticketing_SystemDataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "Ticketing_SystemDataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/Ticketing_SystemDataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As Ticketing_SystemDataSet = New Ticketing_SystemDataSet()
    ...
    Partial Public Class USERSDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddUSERSRow(ByVal USER_ID As String, ByVal FIRST_NAME As String, ByVal LAST_NAME As String, ByVal ADDRESS As String, ByVal CITY As String, ByVal DOB As String, ByVal USER_NAME As String, ByVal PASSWORD As String) As USERSRow
            Dim rowUSERSRow As USERSRow = CType(Me.NewRow,USERSRow)
            Dim columnValuesArray() As Object = New Object() {USER_ID, FIRST_NAME, LAST_NAME, ADDRESS, CITY, DOB, USER_NAME, PASSWORD}
    ...
    Partial Public Class USERSRow
        ...
        Public Property DOB() As String
            Get
                Try 
                    Return CType(Me(Me.tableUSERS.DOBColumn),String)
                Catch e As Global.System.InvalidCastException
...
Namespace Ticketing_SystemDataSetTableAdapters
    ...
    Partial Public Class USERSTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `USERS` WHERE ((`USER_ID` = ?) AND ((? = 1 AND `PASSWORD` IS NULL) OR"& _ 
                " (`PASSWORD` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `USERS` (`USER_ID`, `FIRST_NAME`, `LAST_NAME`, `ADDRESS`, `CITY`, `DO"& _ 
                "B`, `USER_NAME`, `PASSWORD`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("USER_NAME", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "USER_NAME", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `USERS` SET `USER_ID` = ?, `FIRST_NAME` = ?, `LAST_NAME` = ?, `ADDRESS` = "& _ 
                "?, `CITY` = ?, `DOB` = ?, `USER_NAME` = ?, `PASSWORD` = ? WHERE ((`USER_ID` = ?)"& _ 
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("USER_NAME", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "USER_NAME", Global.System.Data.DataRowVersion.Current, false, Nothing))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT USER_ID, FIRST_NAME, LAST_NAME, ADDRESS, CITY, DOB, USER_NAME, [PASSWORD] "& _ 
                "FROM USERS"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "DELETE FROM USERS"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (USER_ID = ?) AND (? = 1) AND ([PASSWORD] IS NULL"& _ 
                ") OR"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         (USER_ID = ?) AND ([PASSWORD] = ?)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("USER_ID", Global.System.Data.OleDb.OleDbType.WChar, 255, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "USER_ID", Global.System.Data.DataRowVersion.Original, false, Nothing))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("USER_ID1", Global.System.Data.OleDb.OleDbType.WChar, 255, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "USER_ID", Global.System.Data.DataRowVersion.Original, false, Nothing))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("USER_ID2", Global.System.Data.OleDb.OleDbType.WChar, 255, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "USER_ID", Global.System.Data.DataRowVersion.Original, false, Nothing))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("PASSWORD", Global.System.Data.OleDb.OleDbType.WChar, 8, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "PASSWORD", Global.System.Data.DataRowVersion.Original, false, Nothing))
            Me._commandCollection(2) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "SELECT        USER_NAME, [PASSWORD]"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            USERS"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (USER_NA"& _ 
                "ME LIKE USER_NAME) AND ([PASSWORD] LIKE [PASSWORD])"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Ticketing_SystemDataSet.USERSDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Ticketing_SystemDataSet.USERSDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Ticketing_SystemDataSet.USERSDataTable = New Ticketing_SystemDataSet.USERSDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Ticketing_SystemDataSet.USERSDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As Ticketing_SystemDataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_USER_ID As String, ByVal Original_PASSWORD As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal USER_ID As String, ByVal FIRST_NAME As String, ByVal LAST_NAME As String, ByVal ADDRESS As String, ByVal CITY As String, ByVal DOB As String, ByVal USER_NAME As String, ByVal PASSWORD As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal USER_ID As String, ByVal FIRST_NAME As String, ByVal LAST_NAME As String, ByVal ADDRESS As String, ByVal CITY As String, ByVal DOB As String, ByVal USER_NAME As String, ByVal PASSWORD As String, ByVal Original_USER_ID As String, ByVal Original_PASSWORD As String) As Integer
            If (USER_ID Is Nothing) Then
                Throw New Global.System.ArgumentNullException("USER_ID")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal FIRST_NAME As String, ByVal LAST_NAME As String, ByVal ADDRESS As String, ByVal CITY As String, ByVal DOB As String, ByVal USER_NAME As String, ByVal PASSWORD As String, ByVal Original_USER_ID As String, ByVal Original_PASSWORD As String) As Integer
            Return Me.Update(Original_USER_ID, FIRST_NAME, LAST_NAME, ADDRESS, CITY, DOB, USER_NAME, PASSWORD, Original_USER_ID, Original_PASSWORD)
        End Function
        ...
        Public Overloads Overridable Function DeleteQuery(ByVal USER_ID As String, ByVal USER_ID1 As String, ByVal USER_ID2 As String, ByVal PASSWORD As String) As Integer
            ...
            End If
            If (USER_ID1 Is Nothing) Then
                Throw New Global.System.ArgumentNullException("USER_ID1")
            Else
                command.Parameters(1).Value = CType(USER_ID1,String)
            End If
            If (USER_ID2 Is Nothing) Then
                Throw New Global.System.ArgumentNullException("USER_ID2")
            Else
                command.Parameters(2).Value = CType(USER_ID2,String)
            End If
            If (PASSWORD Is Nothing) Then
                Throw New Global.System.ArgumentNullException("PASSWORD")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Login() As Object
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As Ticketing_SystemDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As Ticketing_SystemDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._uSERSTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As Ticketing_SystemDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._uSERSTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As Ticketing_SystemDataSet) As Integer
